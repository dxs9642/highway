...
<!--content part start-->
	<div class="block clearfix">
		<div class="area_r s_y_m">
			<div class="s_y"><span class="home"></span>您现在的位置：<a href="index.jsp">网站首页</a><span>></span>申请成功</div>
			<div class="main">
            <div class="allpage">
            <div class="blank8"></div>	
              <p>&nbsp;</p>
              ...
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p><span class="error" margin-top:200px;>申请成功，您的卡号为<?php -- ?>,点击<a href="card.jsp">查看</a></span></p>
            </div>
			</div>
		</div>
	</div>
