...
<div class="blank8"></div>	
		<div class="area_r s_y_m">
            ...
            <div class="blank8"></div>	
                       <div class="info">
            <label class="item">储值卡卡号&nbsp;&nbsp;&nbsp;</label><input type="text" class="intext2" name="cardId" />
			</div>
                       <div class="info">
            <label class="item">储值卡密码&nbsp;&nbsp;&nbsp;</label><input type="password" class="intext2" name="cardPassword" />
			</div>
