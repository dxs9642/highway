...
<!--content part start-->
    ...
    <legend>个人资料</legend>
            ...
            if(user!=null){
            	out.print("<form name=\"addressform\" action=\"/highway/user/changeAddress\" method=\"post\" >");
            	for(int i=0;i<str.length;i++){
            		out.print("<div class=\"info\">");
            		out.print("<span style=\"float:left; font-size:20px; padding-left:100px; color:#333;\">"+str[i]+"&nbsp;&nbsp;</span>"+"<span style=\"float:left; font-size:20px; color:#red; padding-left:100px;\">");
            		switch(i){
            		case 0:
            		    out.print("&nbsp;&nbsp;");
            			...
            			break;
            		case 1:
            		    out.print("<a href=\"/highway/email.jsp\">"+"<img src=\"images/change.jpg\";/>"+"</a>");
            			out.print(user.getEmail());
            			break;
            		case 2:
            		   
            			out.print("<input type=\"text\" class=\"intext2\" name=\"address\" ></input>");	
            			out.print("<a href=\"javascript:addressform.submit();\">"+"<img src=\"images/change.jpg\";/>"+"</a>"); 
            			break;
            		}
            		out.print("&nbsp;&nbsp;</span></div>");
            	}
