...
<!--content part start-->
    ...
    <legend>个人资料</legend>
            ...
            if(user!=null){
            out.print("<form name=\"emailform\" action=\"/highway/user/changeEmail\" method=\"post\" >");
            	for(int i=0;i<str.length;i++){
            		...
            		case 0:
            			...
            			break;
            		case 1:
            		   out.print("<input type=\"text\" class=\"intext2\" name=\"email\" id=\"email\" onblur=\"checkMail('email')\"></input>");	
            		   out.print("<a href=\"javascript:emailform.submit();\">"+"<img src=\"/highway/highway/images/change.jpg\";/>"+"</a>");
            			break;
            		case 2:
