...
<!--content part start-->
	<div class="block clearfix">
		<div class="area_r s_y_m">
			<div class="s_y"><span class="home"></span>您现在的位置：<a href="index.jsp">网站首页</a><span>></span>存卡查看</div>
			<div class="main" >
            <div class="blank8"></div>
                        <div class="info">
            <label class="item">&nbsp;原密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="password" class="intext2" name="password" />
			</div>
            	        <div class="info">
            <label class="item">密&nbsp;&nbsp;码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="password" class="intext2" name="password" />
			</div>
                                    <div class="info">
            <label class="item">确认密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="password" class="intext2" name="checkPassword" />
			</div>
            <div class="registerBut"> 
            <a href="card.jsp"><input type="reset" value="确定" class="inbuttn2" ></input></a>
</div>
		</div>
	</div>
<!--content for end-->	
