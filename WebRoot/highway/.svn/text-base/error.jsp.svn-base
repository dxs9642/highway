...
<!--dh part start-->
	<div id="dh" class="clearfix">
		<ul>
			...
			<li><a href="info_application.jsp">申请信息</a></li>
			<li><a href="info_consumption.jsp">消费信息</a></li>
...
<!--content part start-->
	<div class="block clearfix">
		<div class="area_r s_y_m">
			<div class="s_y"><span class="home"></span>您现在的位置：<a href="index.jsp">网站首页</a><span>></span>账户错误</div>
			<div class="main">
            <div class="allpage">
            <div class="blank8"></div>	
            <div class="wrongleft">
              ...
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p><span class="error">检测不到信息，请先<a href="login.jsp">登录</a></span></p>
            </div>
			</div>
		</div>
	</div>
