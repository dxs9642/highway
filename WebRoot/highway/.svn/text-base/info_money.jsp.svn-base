...
<!--content part start-->
		<div class="area_r s_y_m">
            ...
            <div class="blank8"></div>	
                        <div class="info">
            <label class="item">填写卡号&nbsp;&nbsp;&nbsp;</label><input type="text" class="intext2" name="cardId" />
			</div>
                        <div class="info">
            <label class="item">充值金额&nbsp;&nbsp;&nbsp;</label><input type="text" class="intext2" name="money" />
			</div>
                        <div class="registerBut"> 
            <a href="checkMoney.jsp"><input type="reset" value="确定" class="inbuttn2" ></input></a>
</div>
			</div>
		</div>
	</div>
